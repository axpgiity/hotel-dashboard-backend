...
const kpiData = {
  kpis: [
    { title: "RevPAR", value: "$142.30", change: "+2.5% vs LY", status: "positive" },
    { title: "GOPPAR", value: "$95.80", change: "+5.1% vs LY", status: "positive" },
    { title: "ADR", value: "$180.12", change: "-1.2% vs LY", status: "negative" },
    { title: "Occupancy Rate", value: "79.0%", change: "+3.0 pts", status: "positive" },
    { title: "RGI (RevPAR Index)", value: "105", change: "vs CompSet", status: "neutral" }
  ],
  chart: {
  ...
  res.json({
    marketBenchmarkingFutureOutlook: {
      ...
      paceChartData: {
        ...
        datasets: [
          { label: "On The Books (Rms)", data: [1200, 2300, 3100], backgroundColor: "#3182ce", borderRadius: 4, barPercentage: 0.6 },
          { label: "STLY (Rms)", data: [1100, 2150, 2900], backgroundColor: "#f59e0b", borderRadius: 4, barPercentage: 0.6 },
          { label: "Target (Rms)", data: [1150, 2250, 3000], backgroundColor: "#7f9cf5", borderRadius: 4, barPercentage: 0.6 }
        ]
      }
    }
  });
